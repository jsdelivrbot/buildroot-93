...
VEXPRESS_FIRMWARE_INSTALL_STAGING = YES
VEXPRESS_FIRMWARE_INSTALL_IMAGES = YES

define VEXPRESS_FIRMWARE_INSTALL_STAGING_CMDS
	$(INSTALL) -d $(STAGING_DIR)/usr/share/vexpress-firmware
	@cp -rfpd $(@D)/* $(STAGING_DIR)/usr/share/vexpress-firmware
endef
